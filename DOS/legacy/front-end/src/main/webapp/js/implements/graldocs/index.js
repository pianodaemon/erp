$(function() {
	...
	var controller = $contextpath.val()+"/controllers/graldocs";
	...
	$('#barra_titulo').find('#td_titulo').append('Edici&oacute;n Codigo ISO');
	...
	var to_make_one_search_string = function(){
		var valor_retorno = "";
		var signo_separador = "=";
                valor_retorno += "codigo" + signo_separador + $busqueda_titulo.val() + "|";
	...
	$tabs_li_funxionalidad = function(){
		...
		$('#forma-graldocs-window').find('#submit').mouseover(function(){
			$('#forma-graldocs-window').find('#submit').removeAttr("src").attr("src","../../img/modalbox/bt1.png");
		});
		$('#forma-graldocs-window').find('#submit').mouseout(function(){
			$('#forma-graldocs-window').find('#submit').removeAttr("src").attr("src","../../img/modalbox/btn1.png");
		});
		$('#forma-graldocs-window').find('#boton_cancelar').mouseover(function(){
			$('#forma-graldocs-window').find('#boton_cancelar').css({backgroundImage:"url(../../img/modalbox/bt2.png)"});
		})
		$('#forma-graldocs-window').find('#boton_cancelar').mouseout(function(){
			$('#forma-graldocs-window').find('#boton_cancelar').css({backgroundImage:"url(../../img/modalbox/btn2.png)"});
		});
		
		$('#forma-graldocs-window').find('#close').mouseover(function(){
			$('#forma-graldocs-window').find('#close').css({backgroundImage:"url(../../img/modalbox/close_over.png)"});
		});
		$('#forma-graldocs-window').find('#close').mouseout(function(){
			$('#forma-graldocs-window').find('#close').css({backgroundImage:"url(../../img/modalbox/close.png)"});
		});
		
		
		$('#forma-graldocs-window').find(".contenidoPes").hide(); //Hide all content
		$('#forma-graldocs-window').find("ul.pestanas li:first").addClass("active").show(); //Activate first tab
		$('#forma-graldocs-window').find(".contenidoPes:first").show(); //Show first tab content
		
		//On Click Event
		$('#forma-graldocs-window').find("ul.pestanas li").click(function() {
			$('#forma-graldocs-window').find(".contenidoPes").hide();
			$('#forma-graldocs-window').find("ul.pestanas li").removeClass("active");
			var activeTab = $(this).find("a").attr("href");
			$('#forma-graldocs-window').find( activeTab , "ul.pestanas li" ).fadeIn().show();
