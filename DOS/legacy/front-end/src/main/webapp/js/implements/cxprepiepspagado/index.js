$(function() {
	var config =  {
		...
		tituloApp: 'Reporte de IEPS Pagado' ,                 
		...
		getController: function(){
			return this.contextpath + "/controllers/cxprepiepspagado";
	...
	$genera_pdf.click(function(event){
		...
		var busqueda = $proveedor.val() +"___"+ $fecha_inicial.val() +"___"+ $fecha_final.val();
