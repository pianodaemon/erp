$(function() {
	var config =  {
		...
		tituloApp: 'Reporte de Saldos por Mes - Cuentas por Pagar' ,                 
	...
	$busqueda_reporte.click(function(event){
		...
		$div_reporte_estados_de_cuenta.children().remove();
			...
			$.post(restful_json_service,arreglo_parametros,function(entry){
				...
				html_fila_vacia +='<tr>';
				html_fila_vacia +='<td align="left"  id="sin_borde" width="100px" height="10"></td>';
				...
				html_fila_vacia +='<td align="right" id="sin_borde" width="10px"></td>';
				html_fila_vacia +='<td align="right" id="sin_borde" width="100px"></td>';
				html_fila_vacia +='<td align="left"  id="sin_borde" width="90px"></td>';
				html_fila_vacia +='<td align="right" id="sin_borde" width="10px"></td>';
				html_fila_vacia +='<td align="right" id="sin_borde" width="120px"></td>';
				html_fila_vacia +='</tr>';
