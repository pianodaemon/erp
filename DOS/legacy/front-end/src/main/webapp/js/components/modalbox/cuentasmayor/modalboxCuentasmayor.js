(function($){
	$.fn.extend({
		modalPanel_cuentasmayor: function() {
			...
			*/
			...
			var overlay = $("<div id='forma-cuentasmayor-overlay'></div>");
			//Create our modal window
			var modalWindow = $("<div id='forma-cuentasmayor-window'></div>");
...
//Add a loader to our page
					...
					$("#forma-cuentasmayor-overlay").append(modalWindow);
