(function($){
	$.fn.extend({
		modalPanel_cancelaanticipo: function() {
			...
			var overlay = $("<div id='forma-cancelaanticipo-overlay'></div>");
			//Create our modal window
			var modalWindow = $("<div id='forma-cancelaanticipo-window'></div>");
...
//Add a loader to our page
					...
					$("#forma-cancelaanticipo-overlay").append(modalWindow);
