(function($){
	$.fn.extend({
		modalPanel_clientsasignarem: function() {
			...
			*/
			...
			var overlay = $("<div id='forma-clientsasignarem-overlay'></div>");
			//Create our modal window
			var modalWindow = $("<div id='forma-clientsasignarem-window'></div>");
...
//Add a loader to our page
					...
					$("#forma-clientsasignarem-overlay").append(modalWindow);
