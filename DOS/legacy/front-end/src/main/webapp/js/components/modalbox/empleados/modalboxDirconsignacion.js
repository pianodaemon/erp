(function($){
	$.fn.extend({
		modalPanel_Dirconsignacion: function() {
			...
			var overlay = $("<div id='forma-dirconsignacion-overlay'></div>");
			//Create our modal window
			var modalWindow = $("<div id='forma-dirconsignacion-window'></div>");
...
//Add a loader to our page
					...
					$("#forma-dirconsignacion-overlay").append(modalWindow);
