(function($){
	$.fn.extend({
		modalPanel_buscafacturas: function() {
			...
			var overlay = $("<div id='forma-buscafacturas-overlay'></div>");
			//Create our modal window
			var modalWindow = $("<div id='forma-buscafacturas-window'></div>");
			...
			//return this.each(function() {
				...
				//$(this).click(function(e) {
					...
					$("#forma-buscafacturas-overlay").append(modalWindow);
