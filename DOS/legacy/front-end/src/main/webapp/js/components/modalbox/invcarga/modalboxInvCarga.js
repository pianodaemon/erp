	...
	$.fn.extend({
		modalPanel_invcarga: function() {
			...
			*/
			...
			var overlay = $("<div id='forma-invcarga-overlay'></div>");
			//Create our modal window
			var modalWindow = $("<div id='forma-invcarga-window'></div>");
...
//Add a loader to our page
					...
					$("#forma-invcarga-overlay").append(modalWindow);
