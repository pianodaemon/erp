	...
	$.fn.extend({
		modalPanel_chequera: function() {
			...
			*/
			...
			var overlay = $("<div id='forma-chequeras-overlay'></div>");
			//Create our modal window
			var modalWindow = $("<div id='forma-chequeras-window'></div>");
...
//Add a loader to our page
					...
					$("#forma-chequeras-overlay").append(modalWindow);
