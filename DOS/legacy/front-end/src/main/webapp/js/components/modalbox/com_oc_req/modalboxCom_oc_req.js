(function($){
	$.fn.extend({
		modalPanel_com_oc_req: function() {
			...
			*/
			...
			var overlay = $("<div id='forma-com_oc_req-overlay'></div>");
			//Create our modal window
			var modalWindow = $("<div id='forma-com_oc_req-window'></div>");
...
//Add a loader to our page
					...
					$("#forma-com_oc_req-overlay").append(modalWindow);
