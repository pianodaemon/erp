	...
	$.fn.extend({
		modalPanel_etiquetas: function() {
			...
			*/
			...
			var overlay = $("<div id='forma-etiquetas-overlay'></div>");
			//Create our modal window
			var modalWindow = $("<div id='forma-etiquetas-window'></div>");
...
//Add a loader to our page
					...
					$("#forma-etiquetas-overlay").append(modalWindow);
