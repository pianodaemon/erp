(function($){
	$.fn.extend({
		modalPanel_clientsclasif1: function() {
			...
			*/
			...
			var overlay = $("<div id='forma-clientsclasif1-overlay'></div>");
			//Create our modal window
			var modalWindow = $("<div id='forma-clientsclasif1-window'></div>");
...
//Add a loader to our page
					...
					$("#forma-clientsclasif1-overlay").append(modalWindow);
