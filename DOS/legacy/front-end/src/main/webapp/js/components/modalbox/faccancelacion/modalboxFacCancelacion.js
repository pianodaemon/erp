(function($){
	$.fn.extend({
		modalPanel_faccancelacion: function() {
			...
			var overlay = $("<div id='forma-faccancelacion-overlay'></div>");
			//Create our modal window
			var modalWindow = $("<div id='forma-faccancelacion-window'></div>");
...
//Add a loader to our page
					...
					$("#forma-faccancelacion-overlay").append(modalWindow);
