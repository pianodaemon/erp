(function($){
	$.fn.extend({
		modalPanel_buscactacontable: function() {
			...
			var overlay = $("<div id='forma-buscactacontable-overlay'></div>");
			//Create our modal window
			var modalWindow = $("<div id='forma-buscactacontable-window'></div>");
...
//Add a loader to our page
					...
					$("#forma-buscactacontable-overlay").append(modalWindow);
