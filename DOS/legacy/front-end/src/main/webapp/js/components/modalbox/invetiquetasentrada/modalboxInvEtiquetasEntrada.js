(function($){
	$.fn.extend({
		modalPanel_invetiquetasentrada: function() {
			...
			*/
			...
			var overlay = $("<div id='forma-invetiquetasentrada-overlay'></div>");
			//Create our modal window
			var modalWindow = $("<div id='forma-invetiquetasentrada-window'></div>");
			...
			//return this.each(function() {
				...
				//$(this).click(function(e) {
					...
					$("#forma-invetiquetasentrada-overlay").append(modalWindow);
