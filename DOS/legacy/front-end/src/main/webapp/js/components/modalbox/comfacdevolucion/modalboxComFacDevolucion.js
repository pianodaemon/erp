(function($){
	$.fn.extend({
		modalPanel_comfacdevolucion: function() {
			...
			*/
			...
			var overlay = $("<div id='forma-comfacdevolucion-overlay'></div>");
			//Create our modal window
			var modalWindow = $("<div id='forma-comfacdevolucion-window'></div>");
...
//Add a loader to our page
					...
					$("#forma-comfacdevolucion-overlay").append(modalWindow);
