(function($){
	$.fn.extend({
		modalPanel_crmregistrocasos: function() {
			...
			*/
			...
			var overlay = $("<div id='forma-crmregistrocasos-overlay'></div>");
			//Create our modal window
			var modalWindow = $("<div id='forma-crmregistrocasos-window'></div>");
...
//Add a loader to our page
					...
					$("#forma-crmregistrocasos-overlay").append(modalWindow);
