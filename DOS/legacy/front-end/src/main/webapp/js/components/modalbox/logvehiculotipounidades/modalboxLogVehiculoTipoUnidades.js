(function($){
	$.fn.extend({
		modalPanel_logvehiculotipounidades: function() {
			...
			*/
			...
			var overlay = $("<div id='forma-logvehiculotipounidades-overlay'></div>");
			//Create our modal window
			var modalWindow = $("<div id='forma-logvehiculotipounidades-window'></div>");
...
//Add a loader to our page
					...
					$("#forma-logvehiculotipounidades-overlay").append(modalWindow);
