(function($){
	$.fn.extend({
		modalPanelOportunidades: function() {
			...
			var overlay = $("<div id='forma-oportunidades-overlay'></div>");
			//Create our modal window
			var modalWindow = $("<div id='forma-oportunidades-window'></div>");
...
//Add a loader to our page
					...
					$("#forma-oportunidades-overlay").append(modalWindow);
