(function($){
	$.fn.extend({
		modalPanel_cancelapago: function() {
			...
			var overlay = $("<div id='forma-cancelapago-overlay'></div>");
			//Create our modal window
			var modalWindow = $("<div id='forma-cancelapago-window'></div>");
...
//Add a loader to our page
					...
					$("#forma-cancelapago-overlay").append(modalWindow);
