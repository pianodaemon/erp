(function($){
	$.fn.extend({
		modalPanel_cotizacions: function() {
			...
			*/
			...
			var overlay = $("<div id='forma-cotizacions-overlay'></div>");
			//Create our modal window
			var modalWindow = $("<div id='forma-cotizacions-window'></div>");
...
//Add a loader to our page
					...
					$("#forma-cotizacions-overlay").append(modalWindow);
