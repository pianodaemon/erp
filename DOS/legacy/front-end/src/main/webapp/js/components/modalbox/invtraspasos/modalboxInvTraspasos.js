(function($){
	$.fn.extend({
		modalPanel_invtraspasos: function() {
			...
			*/
			...
			var overlay = $("<div id='forma-invtraspasos-overlay'></div>");
			//Create our modal window
			var modalWindow = $("<div id='forma-invtraspasos-window'></div>");
...
//Add a loader to our page
					...
					$("#forma-invtraspasos-overlay").append(modalWindow);
