	...
	$.fn.extend({
		modalPanel_unidades: function() {
			...
			*/
			...
			var overlay = $("<div id='forma-unidades-overlay'></div>");
			//Create our modal window
			var modalWindow = $("<div id='forma-unidades-window'></div>");
...
//Add a loader to our page
					...
					$("#forma-unidades-overlay").append(modalWindow);
