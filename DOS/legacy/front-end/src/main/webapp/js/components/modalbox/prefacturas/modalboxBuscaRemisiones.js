(function($){
	$.fn.extend({
		modalPanel_buscaremision: function() {
			...
			var overlay = $("<div id='forma-buscaremision-overlay'></div>");
			//Create our modal window
			var modalWindow = $("<div id='forma-buscaremision-window'></div>");
			...
			//return this.each(function() {
				...
				//$(this).click(function(e) {
					...
					$("#forma-buscaremision-overlay").append(modalWindow);
