(function($){
	$.fn.extend({
		modalPanel_cotincoterms: function() {
			...
			*/
			...
			var overlay = $("<div id='forma-cotincoterms-overlay'></div>");
			//Create our modal window
			var modalWindow = $("<div id='forma-cotincoterms-window'></div>");
...
//Add a loader to our page
					...
					$("#forma-cotincoterms-overlay").append(modalWindow);
