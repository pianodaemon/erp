(function($){
	$.fn.extend({
		modalPanel_crmregistrovisitas: function() {
			...
			*/
			...
			var overlay = $("<div id='forma-crmregistrovisitas-overlay'></div>");
			//Create our modal window
			var modalWindow = $("<div id='forma-crmregistrovisitas-window'></div>");
...
//Add a loader to our page
					...
					$("#forma-crmregistrovisitas-overlay").append(modalWindow);
