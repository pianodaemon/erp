(function($){
	$.fn.extend({
		modalPanel_estadocuenta: function() {
			...
			var overlay = $("<div id='forma-estadocuenta-overlay'></div>");
			//Create our modal window
			var modalWindow = $("<div id='forma-estadocuenta-window'></div>");
...
//Add a loader to our page
					...
					$("#forma-estadocuenta-overlay").append(modalWindow);
