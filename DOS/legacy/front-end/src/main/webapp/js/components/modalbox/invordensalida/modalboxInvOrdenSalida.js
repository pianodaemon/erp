(function($){
	$.fn.extend({
		modalPanel_invordensalida: function() {
			...
			*/
			...
			var overlay = $("<div id='forma-invordensalida-overlay'></div>");
			//Create our modal window
			var modalWindow = $("<div id='forma-invordensalida-window'></div>");
			...
			//return this.each(function() {
				...
				//$(this).click(function(e) {
					...
					$("#forma-invordensalida-overlay").append(modalWindow);
