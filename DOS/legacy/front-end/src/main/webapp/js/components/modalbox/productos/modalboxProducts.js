	...
	$.fn.extend({
		modalPanel_Products: function() {
			...
			*/
			...
			var overlay = $("<div id='forma-product-overlay'></div>");
			//Create our modal window
			var modalWindow = $("<div id='forma-product-window'></div>");
...
//Add a loader to our page
					...
					$("#forma-product-overlay").append(modalWindow);
