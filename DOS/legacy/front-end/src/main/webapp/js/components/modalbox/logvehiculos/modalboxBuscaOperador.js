(function($){
	$.fn.extend({
		modalPanel_busquedaoperador: function() {
			...
			var overlay = $("<div id='forma-busquedaoperador-overlay'></div>");
			//Create our modal window
			var modalWindow = $("<div id='forma-busquedaoperador-window'></div>");
...
//Add a loader to our page
					...
					$("#forma-busquedaoperador-overlay").append(modalWindow);
