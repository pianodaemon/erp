(function($){
	$.fn.extend({
		modalPanel_provnotascredito: function() {
			...
			*/
			...
			var overlay = $("<div id='forma-provnotascredito-overlay'></div>");
			//Create our modal window
			var modalWindow = $("<div id='forma-provnotascredito-window'></div>");
...
//Add a loader to our page
					...
					$("#forma-provnotascredito-overlay").append(modalWindow);
