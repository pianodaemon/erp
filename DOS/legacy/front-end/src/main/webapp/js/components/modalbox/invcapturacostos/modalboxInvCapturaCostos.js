(function($){
	$.fn.extend({
		modalPanel_invcapturacostos: function() {
			...
			*/
			...
			var overlay = $("<div id='forma-invcapturacostos-overlay'></div>");
			//Create our modal window
			var modalWindow = $("<div id='forma-invcapturacostos-window'></div>");
...
//Add a loader to our page
					...
					$("#forma-invcapturacostos-overlay").append(modalWindow);
