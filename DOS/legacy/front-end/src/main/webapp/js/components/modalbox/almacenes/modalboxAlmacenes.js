	...
	$.fn.extend({
		modalPanel_almacenes: function() {
			...
			*/
			...
			var overlay = $("<div id='forma-almacenes-overlay'></div>");
			//Create our modal window
			var modalWindow = $("<div id='forma-almacenes-window'></div>");
...
//Add a loader to our page
					...
					$("#forma-almacenes-overlay").append(modalWindow);
