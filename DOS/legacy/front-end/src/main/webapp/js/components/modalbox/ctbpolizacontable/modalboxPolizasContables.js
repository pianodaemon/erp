(function($){
	$.fn.extend({
		modalPanel_ctbpolizacontable: function() {
			...
			*/
			...
			var overlay = $("<div id='forma-ctbpolizacontable-overlay'></div>");
			//Create our modal window
			var modalWindow = $("<div id='forma-ctbpolizacontable-window'></div>");
...
//Add a loader to our page
					...
					$("#forma-ctbpolizacontable-overlay").append(modalWindow);
