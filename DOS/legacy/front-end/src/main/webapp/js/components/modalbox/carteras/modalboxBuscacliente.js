(function($){
	$.fn.extend({
		modalPanel_Buscacliente: function() {
			...
			var overlay = $("<div id='forma-buscacliente-overlay'></div>");
			//Create our modal window
			var modalWindow = $("<div id='forma-buscacliente-window'></div>");
...
//Add a loader to our page
					...
					$("#forma-buscacliente-overlay").append(modalWindow);
