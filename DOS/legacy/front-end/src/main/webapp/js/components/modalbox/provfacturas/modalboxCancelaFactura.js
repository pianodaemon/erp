(function($){
	$.fn.extend({
		modalPanel_cancelafactura: function() {
			...
			var overlay = $("<div id='forma-cancelafactura-overlay'></div>");
			//Create our modal window
			var modalWindow = $("<div id='forma-cancelafactura-window'></div>");
...
//Add a loader to our page
					...
					$("#forma-cancelafactura-overlay").append(modalWindow);
