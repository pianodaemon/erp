(function($){
	$.fn.extend({
		modalPanel_depositos: function() {
			...
			var overlay = $("<div id='forma-depositos-overlay'></div>");
			//Create our modal window
			var modalWindow = $("<div id='forma-depositos-window'></div>");
...
//Add a loader to our page
					...
					$("#forma-depositos-overlay").append(modalWindow);
