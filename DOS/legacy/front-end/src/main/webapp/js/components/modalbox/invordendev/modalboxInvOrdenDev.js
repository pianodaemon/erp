(function($){
	$.fn.extend({
		modalPanel_invordendev: function() {
			...
			*/
			...
			var overlay = $("<div id='forma-invordendev-overlay'></div>");
			//Create our modal window
			var modalWindow = $("<div id='forma-invordendev-window'></div>");
			...
			//return this.each(function() {
				...
				//$(this).click(function(e) {
					...
					$("#forma-invordendev-overlay").append(modalWindow);
