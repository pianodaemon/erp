(function($){
	$.fn.extend({
		modalPanel_buscaremitente: function() {
			...
			var overlay = $("<div id='forma-buscaremitente-overlay'></div>");
			//Create our modal window
			var modalWindow = $("<div id='forma-buscaremitente-window'></div>");
...
//Add a loader to our page
					...
					$("#forma-buscaremitente-overlay").append(modalWindow);
