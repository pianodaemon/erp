(function($){
	$.fn.extend({
		modalPanel_presentaciones: function() {
			...
			*/
			...
			var overlay = $("<div id='forma-presentaciones-overlay'></div>");
			//Create our modal window
			var modalWindow = $("<div id='forma-presentaciones-window'></div>");
...
//Add a loader to our page
					...
					$("#forma-presentaciones-overlay").append(modalWindow);
