(function($){
	$.fn.extend({
		modalPanel_clientsdest: function() {
			...
			*/
			...
			var overlay = $("<div id='forma-clientsdest-overlay'></div>");
			//Create our modal window
			var modalWindow = $("<div id='forma-clientsdest-window'></div>");
...
//Add a loader to our page
					...
					$("#forma-clientsdest-overlay").append(modalWindow);
