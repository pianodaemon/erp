(function($){
	$.fn.extend({
		modalPanel_invordenentrada: function() {
			...
			*/
			...
			var overlay = $("<div id='forma-invordenentrada-overlay'></div>");
			//Create our modal window
			var modalWindow = $("<div id='forma-invordenentrada-window'></div>");
			...
			//return this.each(function() {
				...
				//$(this).click(function(e) {
					...
					$("#forma-invordenentrada-overlay").append(modalWindow);
