(function($){
	$.fn.extend({
		modalPanel_centrocostos: function() {
			...
			*/
			...
			var overlay = $("<div id='forma-centrocostos-overlay'></div>");
			//Create our modal window
			var modalWindow = $("<div id='forma-centrocostos-window'></div>");
...
//Add a loader to our page
					...
					$("#forma-centrocostos-overlay").append(modalWindow);
