(function($){
	$.fn.extend({
		modalPanel_cuentasat: function($nombre_producto) {
			...
			var overlay = $("<div id='forma-cuentasat-overlay'></div>");
			//Create our modal window
			var modalWindow = $("<div id='forma-cuentasat-window'></div>");
...
//Add a loader to our page
					...
					$("#forma-cuentasat-overlay").append(modalWindow);
