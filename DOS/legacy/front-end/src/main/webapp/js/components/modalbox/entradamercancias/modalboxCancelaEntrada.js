(function($){
	$.fn.extend({
		modalPanel_cancelaentrada: function() {
			...
			var overlay = $("<div id='forma-cancelaentrada-overlay'></div>");
			//Create our modal window
			var modalWindow = $("<div id='forma-cancelaentrada-window'></div>");
...
//Add a loader to our page
					...
					$("#forma-cancelaentrada-overlay").append(modalWindow);
