(function($){
	$.fn.extend({
		modalPanel_generainforme: function() {
			...
			var overlay = $("<div id='forma-generainforme-overlay'></div>");
			//Create our modal window
			var modalWindow = $("<div id='forma-generainforme-window'></div>");
...
//Add a loader to our page
					...
					$("#forma-generainforme-overlay").append(modalWindow);
