(function($){
	$.fn.extend({
		modalPanel_clientsagenaduanal: function() {
			...
			*/
			...
			var overlay = $("<div id='forma-clientsagenaduanal-overlay'></div>");
			//Create our modal window
			var modalWindow = $("<div id='forma-clientsagenaduanal-window'></div>");
...
//Add a loader to our page
					...
					$("#forma-clientsagenaduanal-overlay").append(modalWindow);
