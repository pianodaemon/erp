(function($){
	$.fn.extend({
		modalPanel_facconsultas: function() {
			...
			var overlay = $("<div id='forma-facconsultas-overlay'></div>");
			//Create our modal window
			var modalWindow = $("<div id='forma-facconsultas-window'></div>");
...
//Add a loader to our page
					...
					$("#forma-facconsultas-overlay").append(modalWindow);
