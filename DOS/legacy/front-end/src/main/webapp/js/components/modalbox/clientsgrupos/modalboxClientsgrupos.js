(function($){
	$.fn.extend({
		modalPanel_clientsgrupos: function() {
			...
			*/
			...
			var overlay = $("<div id='forma-clientsgrupos-overlay'></div>");
			//Create our modal window
			var modalWindow = $("<div id='forma-clientsgrupos-window'></div>");
...
//Add a loader to our page
					...
					$("#forma-clientsgrupos-overlay").append(modalWindow);
