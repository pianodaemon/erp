(function($){
	$.fn.extend({
		modalPanel_invordensalidaetiqueta: function() {
			...
			var overlay = $("<div id='forma-invordensalidaetiqueta-overlay'></div>");
			//Create our modal window
			var modalWindow = $("<div id='forma-invordensalidaetiqueta-window'></div>");
...
//Add a loader to our page
					...
					$("#forma-invordensalidaetiqueta-overlay").append(modalWindow);
