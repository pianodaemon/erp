	...
	$.fn.extend({
		modalPanel_ctbpar: function() {
			...
			*/
			...
			var overlay = $("<div id='forma-ctbpar-overlay'></div>");
			//Create our modal window
			var modalWindow = $("<div id='forma-ctbpar-window'></div>");
...
//Add a loader to our page
					...
					$("#forma-ctbpar-overlay").append(modalWindow);
