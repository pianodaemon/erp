(function($){
	$.fn.extend({
		modalPanel_invajustes: function() {
			...
			*/
			...
			var overlay = $("<div id='forma-invajustes-overlay'></div>");
			//Create our modal window
			var modalWindow = $("<div id='forma-invajustes-window'></div>");
...
//Add a loader to our page
					...
					$("#forma-invajustes-overlay").append(modalWindow);
