(function($){
	$.fn.extend({
		modalPanel_comcomprasautoriza: function() {
			...
			*/
			...
			var overlay = $("<div id='forma-comcomprasautoriza-overlay'></div>");
			//Create our modal window
			var modalWindow = $("<div id='forma-comcomprasautoriza-window'></div>");
...
//					$("body").append(overlay.click(function() { modalHide(); }));
					...
					$("#forma-comcomprasautoriza-overlay").append(modalWindow);
