(function($){
	$.fn.extend({
		modalPanel_BuscaOrdenProduccion: function() {
			...
			var overlay = $("<div id='forma-buscaordenprod-overlay'></div>");
			//Create our modal window
			var modalWindow = $("<div id='forma-buscaordenprod-window'></div>");
...
//Add a loader to our page
					...
					$("#forma-buscaordenprod-overlay").append(modalWindow);
