(function($){
	$.fn.extend({
		modalPanel_graluseredit: function() {
			...
			*/
			...
			var overlay = $("<div id='forma-graluseredit-overlay'></div>");
			//Create our modal window
			var modalWindow = $("<div id='forma-graluseredit-window'></div>");
...
//Add a loader to our page
					...
					$("#forma-graluseredit-overlay").append(modalWindow);
