(function($){
	$.fn.extend({
		modalPanel_clientstmovimientos: function() {
			...
			*/
			...
			var overlay = $("<div id='forma-clientstmovimientos-overlay'></div>");
			//Create our modal window
			var modalWindow = $("<div id='forma-clientstmovimientos-window'></div>");
...
//Add a loader to our page
					...
					$("#forma-clientstmovimientos-overlay").append(modalWindow);
