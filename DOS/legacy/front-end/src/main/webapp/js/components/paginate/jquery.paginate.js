(function($) {
	...
	$.fn.draw = function(o,obj,selectedpage){
		...
		var _first		= $(document.createElement('a')).addClass('jPag-first').html("<img src='../../img/datagrid00/primero.png'/>");
		...
		var _last		= $(document.createElement('a')).addClass('jPag-last').html("<img src='../../img/datagrid00/ultimo.png'/>");
	...
	$.fn.applystyle = function(o,obj,a_css,hover_css,_first,_ul,_ulwrapdiv,_divwrapright){
		var elim_style = function(){
			$(".jPag-last").removeAttr("style");
			$(".jPag-first").removeAttr("style");
		}
		elim_style();
