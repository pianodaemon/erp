(function($){
	$.fn.extend({
		modalPanelVisitas: function() {
			...
			var overlay = $("<div id='forma-visitas-overlay'></div>");
			//Create our modal window
			var modalWindow = $("<div id='forma-visitas-window'></div>");
...
//Add a loader to our page
					...
					$("#forma-visitas-overlay").append(modalWindow);
