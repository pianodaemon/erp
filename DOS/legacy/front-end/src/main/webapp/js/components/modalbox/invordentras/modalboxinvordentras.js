(function($){
	$.fn.extend({
		modalPanel_invordentras: function() {
			...
			*/
			...
			var overlay = $("<div id='forma-invordentras-overlay'></div>");
			//Create our modal window
			var modalWindow = $("<div id='forma-invordentras-window'></div>");
...
//Add a loader to our page
					...
					$("#forma-invordentras-overlay").append(modalWindow);
