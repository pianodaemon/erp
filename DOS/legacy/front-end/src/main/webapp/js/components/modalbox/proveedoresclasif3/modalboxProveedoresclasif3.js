(function($){
	$.fn.extend({
		modalPanel_proveedoresclasif3: function() {
			...
			*/
			...
			var overlay = $("<div id='forma-proveedoresclasif3-overlay'></div>");
			//Create our modal window
			var modalWindow = $("<div id='forma-proveedoresclasif3-window'></div>");
...
//Add a loader to our page
					...
					$("#forma-proveedoresclasif3-overlay").append(modalWindow);
