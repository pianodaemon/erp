(function($){
	$.fn.extend({
		modalPanel_ctbgenerapolizas: function() {
			...
			*/
			...
			var overlay = $("<div id='forma-ctbgenerapolizas-overlay'></div>");
			//Create our modal window
			var modalWindow = $("<div id='forma-ctbgenerapolizas-window'></div>");
...
//Add a loader to our page
					...
					$("#forma-ctbgenerapolizas-overlay").append(modalWindow);
