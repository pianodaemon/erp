(function($){
	$.fn.extend({
		modalPanel_authorize: function() {
			...
			var overlay = $("<div id='forma-authorize-overlay'></div>");
			//Create our modal window
			var modalWindow = $("<div id='forma-authorize-window'></div>");
...
//Add a loader to our page
					...
					$("#forma-authorize-overlay").append(modalWindow);
