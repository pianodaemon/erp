(function($){
	$.fn.extend({
		modalPanel_provparamanticipos: function() {
			...
			*/
			...
			var overlay = $("<div id='forma-provparamanticipos-overlay'></div>");
			//Create our modal window
			var modalWindow = $("<div id='forma-provparamanticipos-window'></div>");
...
//Add a loader to our page
					...
					$("#forma-provparamanticipos-overlay").append(modalWindow);
