(function($){
	$.fn.extend({
		modalPanel_conceptoscontables: function() {
			...
			*/
			...
			var overlay = $("<div id='forma-conceptoscontables-overlay'></div>");
			//Create our modal window
			var modalWindow = $("<div id='forma-conceptoscontables-window'></div>");
...
//Add a loader to our page
					...
					$("#forma-conceptoscontables-overlay").append(modalWindow);
