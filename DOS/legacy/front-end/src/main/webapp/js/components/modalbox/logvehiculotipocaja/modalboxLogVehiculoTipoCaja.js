(function($){
	$.fn.extend({
		modalPanel_logvehiculotipocaja: function() {
			...
			*/
			...
			var overlay = $("<div id='forma-logvehiculotipocaja-overlay'></div>");
			//Create our modal window
			var modalWindow = $("<div id='forma-logvehiculotipocaja-window'></div>");
...
//Add a loader to our page
					...
					$("#forma-logvehiculotipocaja-overlay").append(modalWindow);
