(function($){
	$.fn.extend({
		modalPanel_remisiones: function() {
			...
			*/
			...
			var overlay = $("<div id='forma-remisiones-overlay'></div>");
			//Create our modal window
			var modalWindow = $("<div id='forma-remisiones-window'></div>");
...
//Add a loader to our page
					...
					$("#forma-remisiones-overlay").append(modalWindow);
