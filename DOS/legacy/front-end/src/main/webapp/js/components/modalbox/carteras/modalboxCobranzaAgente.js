(function($){
	$.fn.extend({
		modalPanel_cobranzaagente: function() {
			...
			var overlay = $("<div id='forma-cobranzaagente-overlay'></div>");
			//Create our modal window
			var modalWindow = $("<div id='forma-cobranzaagente-window'></div>");
...
//Add a loader to our page
					...
					$("#forma-cobranzaagente-overlay").append(modalWindow);
