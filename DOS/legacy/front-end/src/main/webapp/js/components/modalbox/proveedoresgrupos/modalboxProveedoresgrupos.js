(function($){
	$.fn.extend({
		modalPanel_proveedoresgrupos: function() {
			...
			*/
			...
			var overlay = $("<div id='forma-proveedoresgrupos-overlay'></div>");
			//Create our modal window
			var modalWindow = $("<div id='forma-proveedoresgrupos-window'></div>");
...
//Add a loader to our page
					...
					$("#forma-proveedoresgrupos-overlay").append(modalWindow);
