(function($){
	$.fn.extend({
		modalPanel_busquedaunidad: function() {
			...
			var overlay = $("<div id='forma-busquedaunidad-overlay'></div>");
			//Create our modal window
			var modalWindow = $("<div id='forma-busquedaunidad-window'></div>");
...
//Add a loader to our page
					...
					$("#forma-busquedaunidad-overlay").append(modalWindow);
