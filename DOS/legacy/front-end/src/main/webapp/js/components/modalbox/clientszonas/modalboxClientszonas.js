(function($){
	$.fn.extend({
		modalPanel_clientszonas: function() {
			...
			*/
			...
			var overlay = $("<div id='forma-clientszonas-overlay'></div>");
			//Create our modal window
			var modalWindow = $("<div id='forma-clientszonas-window'></div>");
...
//Add a loader to our page
					...
					$("#forma-clientszonas-overlay").append(modalWindow);
