	...
	$.fn.extend({
		modalPanel_carteras: function() {
			...
			*/
			...
			var overlay = $("<div id='forma-carteras-overlay'></div>");
			//Create our modal window
			var modalWindow = $("<div id='forma-carteras-window'></div>");
...
//Add a loader to our page
					...
					$("#forma-carteras-overlay").append(modalWindow);
