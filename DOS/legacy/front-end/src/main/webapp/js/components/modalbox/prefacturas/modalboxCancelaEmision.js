(function($){
	$.fn.extend({
		modalPanel_cancelaemision: function() {
			...
			var overlay = $("<div id='forma-cancelaemision-overlay'></div>");
			//Create our modal window
			var modalWindow = $("<div id='forma-cancelaemision-window'></div>");
...
//Add a loader to our page
					...
					$("#forma-cancelaemision-overlay").append(modalWindow);
