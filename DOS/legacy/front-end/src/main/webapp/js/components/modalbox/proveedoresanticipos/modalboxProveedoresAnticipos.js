(function($){
	$.fn.extend({
		modalPanel_proveedoresanticipos: function() {
			...
			*/
			...
			var overlay = $("<div id='forma-proveedoresanticipos-overlay'></div>");
			//Create our modal window
			var modalWindow = $("<div id='forma-proveedoresanticipos-window'></div>");
			...
			//return this.each(function() {
				...
				//$(this).click(function(e) {
					...
					$("#forma-proveedoresanticipos-overlay").append(modalWindow);
