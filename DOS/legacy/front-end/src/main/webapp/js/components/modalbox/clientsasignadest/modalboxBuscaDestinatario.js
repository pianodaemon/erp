(function($){
	$.fn.extend({
		modalPanel_buscadestinatario: function() {
			...
			var overlay = $("<div id='forma-buscadestinatario-overlay'></div>");
			//Create our modal window
			var modalWindow = $("<div id='forma-buscadestinatario-window'></div>");
...
//Add a loader to our page
					...
					$("#forma-buscadestinatario-overlay").append(modalWindow);
