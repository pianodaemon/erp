(function($){
	$.fn.extend({
		modalPanel_invprodsubfamilias: function() {
			...
			*/
			...
			var overlay = $("<div id='forma-invprodsubfamilias-overlay'></div>");
			//Create our modal window
			var modalWindow = $("<div id='forma-invprodsubfamilias-window'></div>");
...
//Add a loader to our page
					...
					$("#forma-invprodsubfamilias-overlay").append(modalWindow);
