(function($){
	$.fn.extend({
		modalPanel_Clasificacion: function() {
			...
			*/
			...
			var overlay = $("<div id='forma-stock-overlay'></div>");
			//Create our modal window
			var modalWindow = $("<div id='forma-stock-window'></div>");
...
//Add a loader to our page
					...
					$("#forma-stock-overlay").append(modalWindow);
