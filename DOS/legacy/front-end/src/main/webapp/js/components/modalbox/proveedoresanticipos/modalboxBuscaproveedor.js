(function($){
	$.fn.extend({
		modalPanel_Buscaproveedor: function() {
			...
			var overlay = $("<div id='forma-buscaproveedor-overlay'></div>");
			//Create our modal window
			var modalWindow = $("<div id='forma-buscaproveedor-window'></div>");
...
//Add a loader to our page
					...
					$("#forma-buscaproveedor-overlay").append(modalWindow);
