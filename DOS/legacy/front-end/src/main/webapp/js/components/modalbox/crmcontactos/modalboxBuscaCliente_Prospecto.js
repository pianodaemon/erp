(function($){
	$.fn.extend({
		modalPanel_BuscaCliente_prospecto: function() {
			...
			var overlay = $("<div id='forma-buscacliente_prospecto-overlay'></div>");
			//Create our modal window
			var modalWindow = $("<div id='forma-buscacliente_prospecto-window'></div>");
...
//Add a loader to our page
					...
					$("#forma-buscacliente_prospecto-overlay").append(modalWindow);
