(function($){
	$.fn.extend({
		modalPanel_clientsdescuentos: function() {
			...
			*/
			...
			var overlay = $("<div id='forma-clientsdescuentos-overlay'></div>");
			//Create our modal window
			var modalWindow = $("<div id='forma-clientsdescuentos-window'></div>");
...
//Add a loader to our page
					...
					$("#forma-clientsdescuentos-overlay").append(modalWindow);
