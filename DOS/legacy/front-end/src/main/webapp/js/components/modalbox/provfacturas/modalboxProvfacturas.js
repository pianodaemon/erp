(function($){
	$.fn.extend({
		modalPanel_provfacturas: function() {
			...
			*/
			...
			var overlay = $("<div id='forma-provfacturas-overlay'></div>");
			//Create our modal window
			var modalWindow = $("<div id='forma-provfacturas-window'></div>");
			...
			//return this.each(function() {
				...
				//$(this).click(function(e) {
					...
					$("#forma-provfacturas-overlay").append(modalWindow);
