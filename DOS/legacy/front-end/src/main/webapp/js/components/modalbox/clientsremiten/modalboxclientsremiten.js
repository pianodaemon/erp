(function($){
	$.fn.extend({
		modalPanel_clientsremiten: function() {
			...
			*/
			...
			var overlay = $("<div id='forma-clientsremiten-overlay'></div>");
			//Create our modal window
			var modalWindow = $("<div id='forma-clientsremiten-window'></div>");
...
//Add a loader to our page
					...
					$("#forma-clientsremiten-overlay").append(modalWindow);
