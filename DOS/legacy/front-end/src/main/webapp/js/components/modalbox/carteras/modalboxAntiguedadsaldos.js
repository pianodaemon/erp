(function($){
	$.fn.extend({
		modalPanel_antiguedadsaldos: function() {
			...
			var overlay = $("<div id='forma-antiguedadsaldos-overlay'></div>");
			//Create our modal window
			var modalWindow = $("<div id='forma-antiguedadsaldos-window'></div>");
...
//Add a loader to our page
					...
					$("#forma-antiguedadsaldos-overlay").append(modalWindow);
