(function($){
	$.fn.extend({
		modalPanel_logoperadores: function() {
			...
			*/
			...
			var overlay = $("<div id='forma-logoperadores-overlay'></div>");
			//Create our modal window
			var modalWindow = $("<div id='forma-logoperadores-window'></div>");
...
//Add a loader to our page
					...
					$("#forma-logoperadores-overlay").append(modalWindow);
