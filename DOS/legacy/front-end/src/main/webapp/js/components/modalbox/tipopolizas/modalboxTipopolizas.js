(function($){
	$.fn.extend({
		modalPanel_tipopolizas: function() {
			...
			*/
			...
			var overlay = $("<div id='forma-tipopolizas-overlay'></div>");
			//Create our modal window
			var modalWindow = $("<div id='forma-tipopolizas-window'></div>");
...
//Add a loader to our page
					...
					$("#forma-tipopolizas-overlay").append(modalWindow);
