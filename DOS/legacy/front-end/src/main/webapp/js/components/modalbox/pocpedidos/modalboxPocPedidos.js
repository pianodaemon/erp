(function($){
	$.fn.extend({
		modalPanel_pocpedidos: function() {
			...
			*/
			...
			var overlay = $("<div id='forma-pocpedidos-overlay'></div>");
			//Create our modal window
			var modalWindow = $("<div id='forma-pocpedidos-window'></div>");
...
//Add a loader to our page
					...
					$("#forma-pocpedidos-overlay").append(modalWindow);
