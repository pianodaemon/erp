(function($){
	$.fn.extend({
		modalPanel_notascredito: function() {
			...
			*/
			...
			var overlay = $("<div id='forma-notascredito-overlay'></div>");
			//Create our modal window
			var modalWindow = $("<div id='forma-notascredito-window'></div>");
...
//Add a loader to our page
					...
					$("#forma-notascredito-overlay").append(modalWindow);
