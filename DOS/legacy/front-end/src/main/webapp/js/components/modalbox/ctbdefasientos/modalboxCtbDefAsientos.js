(function($){
	$.fn.extend({
		modalPanel_ctbdefasientos: function() {
			...
			*/
			...
			var overlay = $("<div id='forma-ctbdefasientos-overlay'></div>");
			//Create our modal window
			var modalWindow = $("<div id='forma-ctbdefasientos-window'></div>");
...
//Add a loader to our page
					...
					$("#forma-ctbdefasientos-overlay").append(modalWindow);
