(function($){
	$.fn.extend({
		modalPanel_logvehiculomarca: function() {
			...
			*/
			...
			var overlay = $("<div id='forma-logvehiculomarca-overlay'></div>");
			//Create our modal window
			var modalWindow = $("<div id='forma-logvehiculomarca-window'></div>");
...
//Add a loader to our page
					...
					$("#forma-logvehiculomarca-overlay").append(modalWindow);
