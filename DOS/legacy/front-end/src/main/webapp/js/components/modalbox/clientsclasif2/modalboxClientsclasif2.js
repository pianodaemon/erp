(function($){
	$.fn.extend({
		modalPanel_clientsclasif2: function() {
			...
			*/
			...
			var overlay = $("<div id='forma-clientsclasif2-overlay'></div>");
			//Create our modal window
			var modalWindow = $("<div id='forma-clientsclasif2-window'></div>");
...
//Add a loader to our page
					...
					$("#forma-clientsclasif2-overlay").append(modalWindow);
