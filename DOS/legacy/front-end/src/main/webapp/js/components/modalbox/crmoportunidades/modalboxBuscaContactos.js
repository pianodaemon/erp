(function($){
	$.fn.extend({
		modalPanel_BuscaContacto: function() {
			...
			var overlay = $("<div id='forma-buscacontactos-overlay'></div>");
			//Create our modal window
			var modalWindow = $("<div id='forma-buscacontactos-window'></div>");
...
//Add a loader to our page
					...
					$("#forma-buscacontactos-overlay").append(modalWindow);
