(function($){
	$.fn.extend({
		modalPanelLlamadas: function() {
			...
			var overlay = $("<div id='forma-llamadas-overlay'></div>");
			//Create our modal window
			var modalWindow = $("<div id='forma-llamadas-window'></div>");
...
//Add a loader to our page
					...
					$("#forma-llamadas-overlay").append(modalWindow);
