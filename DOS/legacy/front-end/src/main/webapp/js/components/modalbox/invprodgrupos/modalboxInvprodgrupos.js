(function($){
	$.fn.extend({
		modalPanel_prodgrupos: function() {
			...
			*/
			...
			var overlay = $("<div id='forma-zonas-overlay'></div>");
			//Create our modal window
			var modalWindow = $("<div id='forma-zonas-window'></div>");
...
//Add a loader to our page
					...
					$("#forma-zonas-overlay").append(modalWindow);
