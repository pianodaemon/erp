(function($){
	$.fn.extend({
		modalPanel_facdevoluciones: function() {
			...
			*/
			...
			var overlay = $("<div id='forma-facdevoluciones-overlay'></div>");
			//Create our modal window
			var modalWindow = $("<div id='forma-facdevoluciones-window'></div>");
...
//Add a loader to our page
					...
					$("#forma-facdevoluciones-overlay").append(modalWindow);
