(function($){
	$.fn.extend({
		modalPanel_proveedoresclasif1: function() {
			...
			*/
			...
			var overlay = $("<div id='forma-proveedoresclasif1-overlay'></div>");
			//Create our modal window
			var modalWindow = $("<div id='forma-proveedoresclasif1-window'></div>");
...
//Add a loader to our page
					...
					$("#forma-proveedoresclasif1-overlay").append(modalWindow);
