(function($){
	$.fn.extend({
		modalPanel_tipocambio: function() {
			...
			*/
			...
			var overlay = $("<div id='forma-tipocambio-overlay'></div>");
			//Create our modal window
			var modalWindow = $("<div id='forma-tipocambio-window'></div>");
...
//Add a loader to our page
					...
					$("#forma-tipocambio-overlay").append(modalWindow);
