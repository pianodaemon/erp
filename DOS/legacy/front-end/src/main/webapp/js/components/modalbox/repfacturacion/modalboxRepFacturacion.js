(function($){
	$.fn.extend({
		modalPanel_repfacturacion: function() {
			...
			var overlay = $("<div id='forma-repfacturacion-overlay'></div>");
			//Create our modal window
			var modalWindow = $("<div id='forma-repfacturacion-window'></div>");
...
//Add a loader to our page
					...
					$("#forma-repfacturacion-overlay").append(modalWindow);
