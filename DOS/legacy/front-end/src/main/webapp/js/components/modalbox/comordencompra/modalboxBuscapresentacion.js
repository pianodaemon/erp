(function($){
	$.fn.extend({
		modalPanel_Buscapresentacion: function() {
			...
			var overlay = $("<div id='forma-buscapresentacion-overlay'></div>");
			//Create our modal window
			var modalWindow = $("<div id='forma-buscapresentacion-window'></div>");
...
//Add a loader to our page
					...
					$("#forma-buscapresentacion-overlay").append(modalWindow);
