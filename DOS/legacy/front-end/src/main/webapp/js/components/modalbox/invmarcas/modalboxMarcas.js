	...
	$.fn.extend({
		modalPanel_marcas: function() {
			...
			*/
			...
			var overlay = $("<div id='forma-marcas-overlay'></div>");
			//Create our modal window
			var modalWindow = $("<div id='forma-marcas-window'></div>");
...
//Add a loader to our page
					...
					$("#forma-marcas-overlay").append(modalWindow);
