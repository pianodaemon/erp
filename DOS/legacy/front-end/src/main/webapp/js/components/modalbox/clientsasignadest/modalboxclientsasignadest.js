(function($){
	$.fn.extend({
		modalPanel_clientsasignadest: function() {
			...
			*/
			...
			var overlay = $("<div id='forma-clientsasignadest-overlay'></div>");
			//Create our modal window
			var modalWindow = $("<div id='forma-clientsasignadest-window'></div>");
...
//Add a loader to our page
					...
					$("#forma-clientsasignadest-overlay").append(modalWindow);
