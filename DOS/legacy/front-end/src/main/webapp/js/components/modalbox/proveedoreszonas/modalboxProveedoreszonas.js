(function($){
	$.fn.extend({
		modalPanel_proveedoreszonas: function() {
			...
			*/
			...
			var overlay = $("<div id='forma-proveedoreszonas-overlay'></div>");
			//Create our modal window
			var modalWindow = $("<div id='forma-proveedoreszonas-window'></div>");
...
//Add a loader to our page
					...
					$("#forma-proveedoreszonas-overlay").append(modalWindow);
