(function($){
	$.fn.extend({
		modalPanel_programacionrutas: function() {
			...
			*/
			...
			var overlay = $("<div id='forma-programacionrutas-overlay'></div>");
			//Create our modal window
			var modalWindow = $("<div id='forma-programacionrutas-window'></div>");
			...
			//return this.each(function() {
				...
				//$(this).click(function(e) {
					...
					$("#forma-programacionrutas-overlay").append(modalWindow);
