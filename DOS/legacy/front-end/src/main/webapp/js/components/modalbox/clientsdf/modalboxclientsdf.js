	...
	$.fn.extend({
		modalPanel_clientsdf: function() {
			...
			*/
			...
			var overlay = $("<div id='forma-clientsdf-overlay'></div>");
			//Create our modal window
			var modalWindow = $("<div id='forma-clientsdf-window'></div>");
...
//Add a loader to our page
					...
					$("#forma-clientsdf-overlay").append(modalWindow);
