(function($){
	$.fn.extend({
		modalPanel_cuentascontables: function() {
			...
			*/
			...
			var overlay = $("<div id='forma-cuentascontables-overlay'></div>");
			//Create our modal window
			var modalWindow = $("<div id='forma-cuentascontables-window'></div>");
...
//Add a loader to our page
					...
					$("#forma-cuentascontables-overlay").append(modalWindow);
