(function($){
	$.fn.extend({
		modalPanel_buscaagen: function() {
			...
			var overlay = $("<div id='forma-buscaagen-overlay'></div>");
			//Create our modal window
			var modalWindow = $("<div id='forma-buscaagen-window'></div>");
...
//Add a loader to our page
					...
					$("#forma-buscaagen-overlay").append(modalWindow);
