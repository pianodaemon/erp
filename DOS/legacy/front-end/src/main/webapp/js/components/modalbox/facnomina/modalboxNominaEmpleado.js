(function($){
	$.fn.extend({
		modalPanel_nominaempleado: function() {
			...
			var overlay = $("<div id='forma-nominaempleado-overlay'></div>");
			//Create our modal window
			var modalWindow = $("<div id='forma-nominaempleado-window'></div>");
...
//Add a loader to our page
					...
					$("#forma-nominaempleado-overlay").append(modalWindow);
