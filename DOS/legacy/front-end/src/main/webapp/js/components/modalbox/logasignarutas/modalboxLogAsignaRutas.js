(function($){
	$.fn.extend({
		modalPanel_logasignarutas: function() {
			...
			*/
			...
			var overlay = $("<div id='forma-logasignarutas-overlay'></div>");
			//Create our modal window
			var modalWindow = $("<div id='forma-logasignarutas-window'></div>");
...
//Add a loader to our page
					...
					$("#forma-logasignarutas-overlay").append(modalWindow);
