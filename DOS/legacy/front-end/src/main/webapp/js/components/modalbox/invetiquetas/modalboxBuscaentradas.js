(function($){
	$.fn.extend({
		modalPanel_Buscaentradas: function() {
			...
			var overlay = $("<div id='forma-buscaentradas-overlay'></div>");
			//Create our modal window
			var modalWindow = $("<div id='forma-buscaentradas-window'></div>");
...
//Add a loader to our page
					...
					$("#forma-buscaentradas-overlay").append(modalWindow);
