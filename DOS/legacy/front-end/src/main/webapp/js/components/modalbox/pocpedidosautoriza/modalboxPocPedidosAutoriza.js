(function($){
	$.fn.extend({
		modalPanel_pocpedidosautoriza: function() {
			...
			*/
			...
			var overlay = $("<div id='forma-pocpedidosautoriza-overlay'></div>");
			//Create our modal window
			var modalWindow = $("<div id='forma-pocpedidosautoriza-window'></div>");
...
//Add a loader to our page
					...
					$("#forma-pocpedidosautoriza-overlay").append(modalWindow);
