(function($){
	$.fn.extend({
		modalPanel_clientsclasif3: function() {
			...
			*/
			...
			var overlay = $("<div id='forma-clientsclasif3-overlay'></div>");
			//Create our modal window
			var modalWindow = $("<div id='forma-clientsclasif3-window'></div>");
...
//Add a loader to our page
					...
					$("#forma-clientsclasif3-overlay").append(modalWindow);
