	...
	$.fn.extend({
		modalPanel_facnomina: function() {
			...
			*/
			...
			var overlay = $("<div id='forma-facnomina-overlay'></div>");
			//Create our modal window
			var modalWindow = $("<div id='forma-facnomina-window'></div>");
...
//Add a loader to our page
					...
					$("#forma-facnomina-overlay").append(modalWindow);
