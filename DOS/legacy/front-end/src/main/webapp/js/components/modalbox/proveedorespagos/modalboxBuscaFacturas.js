(function($){
	$.fn.extend({
		modalPanel_Buscafactura: function() {
			...
			var overlay = $("<div id='forma-buscafactura-overlay'></div>");
			//Create our modal window
			var modalWindow = $("<div id='forma-buscafactura-window'></div>");
...
//Add a loader to our page
					...
					$("#forma-buscafactura-overlay").append(modalWindow);
