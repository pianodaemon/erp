(function($){
	$.fn.extend({
		modalPanel_com_requisicion: function() {
			...
			*/
			...
			var overlay = $("<div id='forma-com_requisicion-overlay'></div>");
			//Create our modal window
			var modalWindow = $("<div id='forma-com_requisicion-window'></div>");
...
//Add a loader to our page
					...
					$("#forma-com_requisicion-overlay").append(modalWindow);
