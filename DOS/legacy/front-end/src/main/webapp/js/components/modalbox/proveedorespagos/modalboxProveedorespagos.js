(function($){
	$.fn.extend({
		modalPanel_proveedorespagos: function() {
			...
			*/
			...
			var overlay = $("<div id='forma-proveedorespagos-overlay'></div>");
			//Create our modal window
			var modalWindow = $("<div id='forma-proveedorespagos-window'></div>");
			...
			//return this.each(function() {
				...
				//$(this).click(function(e) {
					...
					$("#forma-proveedorespagos-overlay").append(modalWindow);
