(function($){
	$.fn.extend({
		modalPanel_proveedorestmovimientos: function() {
			...
			*/
			...
			var overlay = $("<div id='forma-proveedorestmovimientos-overlay'></div>");
			//Create our modal window
			var modalWindow = $("<div id='forma-proveedorestmovimientos-window'></div>");
...
//Add a loader to our page
					...
					$("#forma-proveedorestmovimientos-overlay").append(modalWindow);
