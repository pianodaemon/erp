(function($){
	$.fn.extend({
		modalPanel_invcontrolcostos: function() {
			...
			*/
			...
			var overlay = $("<div id='forma-invcontrolcostos-overlay'></div>");
			//Create our modal window
			var modalWindow = $("<div id='forma-invcontrolcostos-window'></div>");
			...
			//return this.each(function() {
				...
				//$(this).click(function(e) {
					...
					$("#forma-invcontrolcostos-overlay").append(modalWindow);
