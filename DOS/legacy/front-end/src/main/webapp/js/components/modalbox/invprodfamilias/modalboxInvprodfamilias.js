(function($){
	$.fn.extend({
		modalPanel_invprodfamilias: function() {
			...
			*/
			...
			var overlay = $("<div id='forma-invprodfamilias-overlay'></div>");
			//Create our modal window
			var modalWindow = $("<div id='forma-invprodfamilias-window'></div>");
...
//Add a loader to our page
					...
					$("#forma-invprodfamilias-overlay").append(modalWindow);
