(function($){
	$.fn.extend({
		modalPanel_proveedors: function() {
			...
			var overlay = $("<div id='forma-proveedors-overlay'></div>");
			//Create our modal window
			var modalWindow = $("<div id='forma-proveedors-window'></div>");
...
//Add a loader to our page
					...
					$("#forma-proveedors-overlay").append(modalWindow);
