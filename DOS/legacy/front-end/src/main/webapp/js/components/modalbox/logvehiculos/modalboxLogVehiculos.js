(function($){
	$.fn.extend({
		modalPanel_LogVehiculos: function() {
			...
			*/
			...
			var overlay = $("<div id='forma-logvehiculos-overlay'></div>");
			//Create our modal window
			var modalWindow = $("<div id='forma-logvehiculos-window'></div>");
...
//Add a loader to our page
					...
					$("#forma-logvehiculos-overlay").append(modalWindow);
