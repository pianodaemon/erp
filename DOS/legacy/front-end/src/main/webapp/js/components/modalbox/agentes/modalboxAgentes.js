	...
	$.fn.extend({
		modalPanel_agentes: function() {
			...
			*/
			...
			var overlay = $("<div id='forma-agentes-overlay'></div>");
			//Create our modal window
			var modalWindow = $("<div id='forma-agentes-window'></div>");
...
//Add a loader to our page
					...
					$("#forma-agentes-overlay").append(modalWindow);
