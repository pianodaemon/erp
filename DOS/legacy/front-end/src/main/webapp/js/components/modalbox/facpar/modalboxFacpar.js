	...
	$.fn.extend({
		modalPanel_facpar: function() {
			...
			*/
			...
			var overlay = $("<div id='forma-facpar-overlay'></div>");
			//Create our modal window
			var modalWindow = $("<div id='forma-facpar-window'></div>");
...
//Add a loader to our page
					...
					$("#forma-facpar-overlay").append(modalWindow);
