(function($){
	$.fn.extend({
		modalPanel_crmregistroproyectos: function() {
			...
			*/
			...
			var overlay = $("<div id='forma-crmregistroproyectos-overlay'></div>");
			//Create our modal window
			var modalWindow = $("<div id='forma-crmregistroproyectos-window'></div>");
...
//Add a loader to our page
					...
					$("#forma-crmregistroproyectos-overlay").append(modalWindow);
