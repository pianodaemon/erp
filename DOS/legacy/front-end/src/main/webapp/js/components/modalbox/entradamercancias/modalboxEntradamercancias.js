(function($){
	$.fn.extend({
		modalPanel_Entradamercancias: function() {
			...
			*/
			...
			var overlay = $("<div id='forma-entradamercancias-overlay'></div>");
			//Create our modal window
			var modalWindow = $("<div id='forma-entradamercancias-window'></div>");
			...
			//return this.each(function() {
				...
				//$(this).click(function(e) {
					...
					$("#forma-entradamercancias-overlay").append(modalWindow);
