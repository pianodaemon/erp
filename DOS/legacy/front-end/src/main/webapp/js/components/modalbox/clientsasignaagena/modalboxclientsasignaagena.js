(function($){
	$.fn.extend({
		modalPanel_clientsasignaagena: function() {
			...
			*/
			...
			var overlay = $("<div id='forma-clientsasignaagena-overlay'></div>");
			//Create our modal window
			var modalWindow = $("<div id='forma-clientsasignaagena-window'></div>");
...
//Add a loader to our page
					...
					$("#forma-clientsasignaagena-overlay").append(modalWindow);
