(function($){
	$.fn.extend({
		modalPanel_cotpoliticasdepago: function() {
			...
			*/
			...
			var overlay = $("<div id='forma-cotpoliticasdepago-overlay'></div>");
			//Create our modal window
			var modalWindow = $("<div id='forma-cotpoliticasdepago-window'></div>");
...
//Add a loader to our page
					...
					$("#forma-cotpoliticasdepago-overlay").append(modalWindow);
