	...
	$.fn.extend({
		modalPanel_plazas: function() {
			...
			*/
			...
			var overlay = $("<div id='forma-plazas-overlay'></div>");
			//Create our modal window
			var modalWindow = $("<div id='forma-plazas-window'></div>");
...
//Add a loader to our page
					...
					$("#forma-plazas-overlay").append(modalWindow);
