(function($){
	$.fn.extend({
		modalPanel_proveedoresdirecciones: function() {
			...
			*/
			...
			var overlay = $("<div id='forma-proveedoresdirecciones-overlay'></div>");
			//Create our modal window
			var modalWindow = $("<div id='forma-proveedoresdirecciones-window'></div>");
...
//Add a loader to our page
					...
					$("#forma-proveedoresdirecciones-overlay").append(modalWindow);
