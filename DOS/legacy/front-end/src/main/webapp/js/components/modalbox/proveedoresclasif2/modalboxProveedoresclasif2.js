(function($){
	$.fn.extend({
		modalPanel_proveedoresclasif2: function() {
			...
			*/
			...
			var overlay = $("<div id='forma-proveedoresclasif2-overlay'></div>");
			//Create our modal window
			var modalWindow = $("<div id='forma-proveedoresclasif2-window'></div>");
...
//Add a loader to our page
					...
					$("#forma-proveedoresclasif2-overlay").append(modalWindow);
