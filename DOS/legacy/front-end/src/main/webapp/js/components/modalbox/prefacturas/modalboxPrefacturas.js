(function($){
	$.fn.extend({
		modalPanel_prefacturas: function() {
			...
			*/
			...
			var overlay = $("<div id='forma-prefacturas-overlay'></div>");
			//Create our modal window
			var modalWindow = $("<div id='forma-prefacturas-window'></div>");
...
//Add a loader to our page
					...
					$("#forma-prefacturas-overlay").append(modalWindow);
