(function($){
	$.fn.extend({
		modalPanel_logvehiculotiporodada: function() {
			...
			*/
			...
			var overlay = $("<div id='forma-logvehiculotiporodada-overlay'></div>");
			//Create our modal window
			var modalWindow = $("<div id='forma-logvehiculotiporodada-window'></div>");
...
//Add a loader to our page
					...
					$("#forma-logvehiculotiporodada-overlay").append(modalWindow);
