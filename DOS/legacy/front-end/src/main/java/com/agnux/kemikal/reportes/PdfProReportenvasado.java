 ...
 * @author mi_compu
 */
public class PdfProReportenvasado {

    public PdfProReportenvasado(String fileout, String ruta_imagen, String razon_social_empresa, String fecha_inicial, String fecha_final, ArrayList<HashMap<String, String>> Datos_Reporte_Envasado) throws DocumentException {
        ...
        try {
            ...
            PdfProReportenvasado.HeaderFooter event = new PdfProReportenvasado.HeaderFooter(razon_social_empresa,periodo_reporte);
            ...
            // Encabezado de Celda
            cell = new PdfPCell(new Paragraph("ENVASADO_1",headerFont));
            ...
            cell = new PdfPCell(new Paragraph("ENVASADO_2",headerFont));
            cell.setUseAscender(true);
            cell.setHorizontalAlignment(Element.ALIGN_LEFT);
            cell.setUseDescender(true);
            cell.setVerticalAlignment(Element.ALIGN_MIDDLE);
            ...
            if(Datos_Reporte_Envasado.size() > 0){


                for (int x=0; x<=Datos_Reporte_Envasado.size()-1;x++){
                    HashMap<String,String> registro = Datos_Reporte_Envasado.get(x);
    ...
    static class HeaderFooter extends PdfPageEventHelper {
        ...
        public void onEndPage(PdfWriter writer, Document document) {
            ...
            ColumnText.showTextAligned(writer.getDirectContent(),Element.ALIGN_CENTER, new Phrase("Reporte de Envasado",largeBoldFont),document.getPageSize().getWidth()/2, document.getPageSize().getTop()-38, 0);
