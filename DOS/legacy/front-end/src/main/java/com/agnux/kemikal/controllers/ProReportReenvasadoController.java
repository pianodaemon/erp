...
import com.agnux.kemikal.reportes.PdfProReportReenvasado;
...
@RequestMapping("/proreportreenvasado/")
public class ProReportReenvasadoController {
    private static final Logger log  = Logger.getLogger(ProReportReenvasadoController.class.getName());
    ...
    public ModelAndView startUp(HttpServletRequest request, HttpServletResponse response,
        ...
        log.log(Level.INFO, "Ejecutando starUp de {0}", ProReportReenvasadoController.class.getName());
        LinkedHashMap<String,String> infoConstruccionTabla = new LinkedHashMap<String,String>();


        ModelAndView x = new ModelAndView("proreportreenvasado/startup", "title", "Reporte de Reenvasado");
    ...
    public @ResponseBody HashMap<String,ArrayList<HashMap<String, String>>> getDatosBusquedaJson(
        ...
        log.log(Level.INFO, "Ejecutando getDatosBusquedaJson de {0}", ProReportReenvasadoController.class.getName());
        HashMap<String,ArrayList<HashMap<String, String>>> jsonretorno = new HashMap<String,ArrayList<HashMap<String, String>>>();
        //ArrayList<HashMap<String, String>> Almacenes = new ArrayList<HashMap<String, String>>();
        ArrayList<HashMap<String, String>>Datos_Reporte_Reenvasado = new ArrayList<HashMap<String, String>>();
        ...
        Datos_Reporte_Reenvasado = this.getProDao().getReportReenvasado_Datos(id_empresa);

        //jsonretorno.put("Agentes", Almacenes);
        jsonretorno.put("R_Reenvasado", Datos_Reporte_Reenvasado);
...
//
//
    @RequestMapping(method = RequestMethod.POST, value = "/getProReportReenvasado.json")
    public @ResponseBody
    HashMap<String, ArrayList<HashMap<String, String>>> getProReportReenvasadoJson(
            @RequestParam(value = "id_agente", required = true) String id_agente,
            @RequestParam(value = "iu", required = true) String id_user,
            Model model) {

        log.log(Level.INFO, "Ejecutando getProReportReenvasadoJson de {0}", ProReportReenvasadoController.class.getName());
        HashMap<String, ArrayList<HashMap<String, String>>> jsonretorno = new HashMap<String, ArrayList<HashMap<String, String>>>();
        ArrayList<HashMap<String, String>>Datos_Reporte_Reenvasado = new ArrayList<HashMap<String, String>>();
        HashMap<String, String> userDat = new HashMap<String, String>();
        //decodificar id de usuario
       ...
       Datos_Reporte_Reenvasado = this.getProDao().getReportReenvasado_Datos(id_empresa);
        ...
        jsonretorno.put("Datos_R_Reenvasado",Datos_Reporte_Reenvasado);

        return jsonretorno;
    }


    //Genera pdf Reporte deReenvasado getProReportReenvasado
    ...
    public ModelAndView getGeneraPdfRemisionJson(
        ...
        String file_name = "REPREENVASADO_"+rfc+".pdf";

        //ruta de archivo de salida
        String fileout = file_dir_tmp +"/"+  file_name;


        //obtiene los datos Para el reporte de Reenvasado (Modulo de Produccion)
      //Datos_Reporte_Reenvasado = this.getProDao().getReportReenvasado_Datos(id_empresa);
        Datos_Reporte_Reenvasado = this.getProDao().getReportReenvasado_Datos(id_empresa);

        //instancia a la clase que construye el pdf del reporte de Reenvasado
        PdfProReportReenvasado x = new PdfProReportReenvasado( fileout,ruta_imagen,razon_social_empresa,fecha_inicial,fecha_final,Datos_Reporte_Reenvasado);
