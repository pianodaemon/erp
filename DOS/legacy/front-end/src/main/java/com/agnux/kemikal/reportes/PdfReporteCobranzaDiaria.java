...
/**
 *
 * @author valentin.vale
 */
public class PdfReporteCobranzaDiaria {
    
          public PdfReporteCobranzaDiaria(HashMap<String, String> datosEncabezadoPie, String fileout, ArrayList<HashMap<String, String>> lista_CobranzaDiaria, HashMap<String, String> datos) throws DocumentException {
...
//                    double suma_saldo = 0.0;
                    ...
                    HeaderFooter event = new PdfReporteCobranzaDiaria.HeaderFooter(datos);
                    ...
                    String titulos[ ] ={"Factura","Fecha","Cliente","","Monto Factura","","Pago Aplicado","Fecha Pago","","Monto Pago"};
...
//                }
            ...
            for (int x=0; x<=(lista_CobranzaDiaria.size())-1; x++){
                 HashMap<String, String> registro= lista_CobranzaDiaria.get(x);
