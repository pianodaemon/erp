 ...
 * @author Ezcure
 */
public class PdfEstadisticoVentasAnualesXUnidades {
    
    public PdfEstadisticoVentasAnualesXUnidades (String fileout, String ruta_imagen, String razon_social_empresa, String mes_inicial, String mes_final, ArrayList<HashMap<String, String>> lista_ventas_anuales) throws DocumentException, FileNotFoundException{
        ...
        String periodo = "Periodo del mes de:"+" "+ mes_inicial +" al mes de: "+" "+mes_final;
        ...
        datos.put("titulo_reporte", "Reporte Estadístico de Ventas Anuales por Unidades");
        ...
        PdfEstadisticoVentasAnualesXCliente.HeaderFooter event = new PdfEstadisticoVentasAnualesXCliente.HeaderFooter(datos);
        ...
        try {
            ...
            for (int j=0;j<lista_ventas_anuales.size();j++){
                 ...
                 //1-13           
                 celda = new PdfPCell(new Paragraph(registro.get("descripcion"),fuenteCont2));
                 celda.setUseAscender(true);
