 ...
 * @author Ezcure
 */
public class PdfEstadisticoVentasAnualesXProducto {
    
    public PdfEstadisticoVentasAnualesXProducto (String fileout, String ruta_imagen, String razon_social_empresa, String mes_inicial, String mes_final, ArrayList<HashMap<String, String>> lista_ventas_anuales) throws DocumentException, FileNotFoundException{
