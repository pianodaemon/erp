 ...
 * @author pianodaemon
 */
public final class PdfReporteBalanzaDeComprobacion {
    ...
    public PdfReporteBalanzaDeComprobacion(String fileout,List<HashMap<String, String>> itemsForPrinting, HashMap<String, String> datosEmpresa){
    ...
    void init(){
        ...
        try {
            ...
            Logger.getLogger(PdfReporteBalanzaDeComprobacion.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    public final class HeaderFooter extends PdfPageEventHelper {
        ...
        public void onEndPage(PdfWriter writer, Document document) {
            ...
            ColumnText.showTextAligned(writer.getDirectContent(),Element.ALIGN_CENTER, new Phrase("Balanza de Comprobacion",largeBoldFont),document.getPageSize().getWidth()/2, document.getPageSize().getTop()-38, 0);
